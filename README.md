...
- `src/net/` — Supabase client, guest auth, PartyKit client, profile + sync
- `src/game/sim/` — authoritative arena sim (shared with PartyKit server)
- `party/spellbrawl.ts` — PartyKit room handler (lobby → draft → arena)
